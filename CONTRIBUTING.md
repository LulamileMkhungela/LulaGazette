# Contributing to LulaGazette

Thanks for your interest. This project is owned and steered by **Lulamile Mkhungela**.
...
npm install
npm run dev
npm run build   # must pass before you send a PR
npm run lint
```
...
- Note any new dependencies and their licences.  
- Do not commit `.env`, secrets, or client matter data.

## Licence of contributions

By submitting a contribution, you agree that it may be included in LulaGazette under the repository [LICENSE](./LICENSE) and assigned or licensed to the copyright holder as needed to operate the product.
