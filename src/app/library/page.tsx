...
const INITIAL_COMMUNITY_DOCS: UploadedDoc[] = [
  ...
  {
    id: "lib-com-na-1",
    title: "High Court of Namibia Practice Directive — Electronic Filing via e-Justice & Case Management",
    citation: "HC-MD-CIV-DIR-2025/03",
    category: "court-rules",
    country: "Namibia",
    countryCode: "NA",
    summary: "Mandatory practice directions for Judicial Case Management (JCM), status reports, and managing trial rolls in Windhoek.",
    uploader: "Adv. Hendrik Van Zyl (Namibia Bar)",
    uploadedAt: "2026-09-14",
    isCommunity: true,
  },
  {
    id: "lib-com-bw-1",
    title: "Industrial Court of Botswana Dispute Settlement & Conciliation Practice Notice",
    citation: "ICB Practice Circular 1/2025",
    category: "court-rules",
    country: "Botswana",
    countryCode: "BW",
    summary: "Filing timetables and preliminary hearing rules for trade disputes and unfair termination claims in Gaborone.",
    uploader: "Tshepo Modise (Law Society of Botswana)",
    uploadedAt: "2026-09-11",
    isCommunity: true,
  },
  {
    id: "lib-com-eg-1",
    title: "Cairo Commercial Chamber Electronic Pleadings & Evidentiary Guide",
    citation: "Ministry of Justice Directive No. 44/2025",
    category: "court-rules",
    country: "Egypt",
    countryCode: "EG",
    summary: "Standard procedural instructions for digital submission of pleadings and judicial declarations in Cairo.",
    uploader: "Karim El-Sayed (Egyptian Bar Association)",
